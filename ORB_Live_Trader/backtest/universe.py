"""
Unified Universe Generator
Ported from enrich_sentiment_universe.py and build_universe.py
"""
import sys
import argparse
import pandas as pd
...
# -----------------------------------------------------------------------------
# Helpers imported from build_universe.py
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Core Logic from enrich_sentiment_universe.py
# -----------------------------------------------------------------------------
...
def main():
    ...
    # Use centralized universe directory
    UNIVERSE_ROOT = DATA_DIR / "backtest" / "orb" / "universe"
